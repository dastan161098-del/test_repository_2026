        ...
        while True:
            ...
            if [x, y] not in snake_positions and [x, y] not in walls_positions:
                ...
                food_type = random.choice([
                    ...
                    {"weight": 2, "color": YELLOW, "lifetime": 5000},
                    {"weight": 3, "color": PURPLE, "lifetime": 4000}
                ])
...
def main():
    ...
    while running:
        ...
        if game_active:
            ...
            weight_text = font.render(f"Food Weight: {food.weight}", True, ORANGE)
